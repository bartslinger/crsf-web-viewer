<script lang="ts">
	...
	import { type CrsfRadioIdMessage } from '$lib/crsf';
	...
	class CrsfMessageTransformer {
		...
		transform(bytes: number[], controller) {
			...
			if (message_type === 0x3a) {
				...
				const update_interval = view.getUint32(6, false);
				const offset = view.getInt32(10, false);
				let message: CrsfRadioIdMessage = {
					update_interval,
					offset
				};
